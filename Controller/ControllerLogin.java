...
public class ControllerLogin implements ActionListener, KeyListener, FocusListener{
    ...
    Object obj = ae.getSource();
        ...
        }else if (obj.equals(vBegin.getExit())){
            System.exit(0);
        }
    }
           ...
           user.setPassword(password);
            ...
            if(validate){ 
                ...
                if (users == false){
                    ...
                    boolean position = user.searchPositionByIdUser();
                ...
                vBegin.setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
                vBegin.getRemark().setText(null);
                JOptionPane.showMessageDialog(new JFrame(),"Invalid username or password \n If you forget one of them, get in touch with the developers: \n Idan Klopper - idnakloppfer@gmail.com \n Hen Ifrah - hen.ifrah@gmail.com","information",JOptionPane.INFORMATION_MESSAGE);
            }
    }
    ...
    public void keyTyped(KeyEvent ke) {
      ...
      if(obj.equals(vBegin.getUserName())){
          if(vBegin.getUserName().getText().length()>20){
                ke.consume();
            }
      }else if(obj.equals(vBegin.getPassword())){
    ...
    public void keyPressed(KeyEvent ke) {
         Object obj = ke.getSource();
         if(obj.equals(vBegin.getPassword())){
