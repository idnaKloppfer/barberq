...
public class Vhaircut extends javax.swing.JDialog {
     ...
     */
    public void setController(ControllerMeeting controllerMeeting){
	...
	private void variablesForm() {
		...
		hairCutPanel.setPreferredSize(new Dimension(600, 500));
		...
		tableHairCut.setFont(new Font("Times New Roman", Font.PLAIN, 19)); 
