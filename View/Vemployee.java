...
public class Vemployee extends javax.swing.JDialog {
     ...
     * @param controller
     */
    public void setControllerMetting(ControllerMeeting controller){
    ...
    private void variablesForm() {
        ...
        employeePanel.setMaximumSize(new Dimension(600, 500));
        employeePanel.setPreferredSize(new Dimension(600, 500));
        ...
        employeeTable.setFont(new Font("Times New Roman", Font.PLAIN, 19)); 
