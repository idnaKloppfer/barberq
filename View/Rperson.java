...
public class Rperson extends javax.swing.JDialog {
    ...
    private void variablesForm() {
        ...
        panelRPerson = new org.edisoncor.gui.panel.Panel();
        ...
        panelRPerson.setMaximumSize(new java.awt.Dimension(737, 504));
        panelRPerson.setPreferredSize(new java.awt.Dimension(737, 310));
        panelRPerson.setLayout(new java.awt.BorderLayout());
        ...
        panelRPerson.add(header, java.awt.BorderLayout.NORTH);
        ...
        panelRPerson.add(center, java.awt.BorderLayout.CENTER);
        ...
        panelRPerson.add(footer, java.awt.BorderLayout.SOUTH);

        getContentPane().add(panelRPerson, "card2");
    ...
    private org.edisoncor.gui.panel.Panel panelRPerson;
