...
public class Vworkposition extends javax.swing.JDialog {
    ...
    private void variablesForm() {
        ...
        workPositionPanel.setPreferredSize(new Dimension(600, 500));
        ...
        workPositionTable.setFont(new Font("Times New Roman", Font.PLAIN, 19)); 
    ...
    private void textSearchFocusGained(java.awt.event.FocusEvent evt) {
        String txt = "Find the matching job position";
