...
public class Begin extends JFrame{
    ...
    private void setControllerLogin(ControllerLogin controllerLogin){
        this.controllerLogin = controllerLogin;
        this.setListener();
     }

    private void setListener(){
        userName.addFocusListener(controllerLogin);  
        password.addFocusListener(controllerLogin);  
        sign.addActionListener(controllerLogin);
        exit.addActionListener(controllerLogin);
    }
    ...
    public Begin(){
        ...
        this.assignCenter();
        this.assignFooter();
        this.setControllerLogin(new ControllerLogin(this));
        setVisible(true);
